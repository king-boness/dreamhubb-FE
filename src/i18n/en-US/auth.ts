export default {
  ...
  resetLinkSentGeneric: "If the account exists, we sent you an email with instructions.",
  resetPasswordSetTitle: "Set a new password",
  resetLinkInvalidOrExpired: "This reset link is invalid or expired.",
  ...
  explainerTitle3: "Earn Tokens by helping",
  ...
  forgotPasswordHint: "Forgot your password? Reset it.",
  forgotPasswordUnavailableTitle: "Password reset",
  forgotPasswordUnavailableText: "Password reset isn't available yet. Please contact support.",
